...
// Homepage map - Google
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
function getTypeIcon(json){
     if (json.kind.toUpperCase() == 'APARTAMENTO') {
         return '<img src="assets/icons/real-estate/apartment-3.png">';
     }else if (json.kind.toUpperCase() == 'SOBRADO') {
         return '<img src="assets/icons/real-estate/townhouse.png">';
     }else if (json.kind.toUpperCase() == 'CASA'){
         return '<img src=assets/icons/real-estate/house.png>';
     }else if ((json.kind.toUpperCase() == 'SALA COMERCIAL') || (json.kind.toUpperCase() == 'BARRACÃO')){
         return '<img src="assets/icons/real-estate/office-building.png">';
     }else{
         return '<img src="assets/icons/real-estate/condominium.png">';
     }
}
...
//    });
    //function gMap(){
        ...
        for (var i = 0; i < json.length; i++) {
            ...
            json[i].color = 0;
            json[i].type_icon = getTypeIcon(json[i]);
            var type_icon = json[i].type_icon;
            json[i].featured  = 0;
            var featured = json[i].featured;
            ...
            google.maps.event.addListener(marker, 'click', (function(marker, i) {
                return function() {
                  ...
                  var params = '?uid=' + realty.hash_key;
                    $.ajax({
                        type: 'GET',
                        url: 'http://larja-back.herokuapp.com/extra/getinfo/' + params,
                        //url: 'http://leandro-parazito:8000/extra/getinfo/' + params,
        ...
        google.maps.event.addListener(map, 'idle', function() {
            ...
            for( var a = 0; a < json.length; a++ ){
                if( map.getBounds().contains( new google.maps.LatLng( json[a].latitude, json[a].longitude ) ) ) {
                    if ( tempVar < 20 ) {
                        tempVar++;
                        pushItemsToArray(json[a], json[a].id, visibleItemsArray, 'resultsSidebar');
                    }
                }
            }
...
function pushItemsToArray(json, id, visibleItemsArray, method){
    ...
    var params = '?uid=' + json.hash_key;
    $.ajax({
        type: 'GET',
        url: 'http://larja-back.herokuapp.com/extra/getresult/' + params,
        //url: 'http://leandro-parazito:8000/extra/getresult/' + params,
        data: id,
        success: function (data) {
