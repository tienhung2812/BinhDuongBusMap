...
//  iCheck -------------------------------------------------------------------------------------------------------------
    ...
    //*[@id="mCSB_1_container"]/div/div/form/div/div[1]/div/div/div/ul/li[2]/a
...
function quickView(id){
    var params = '?hash_key=' + id;
    $.ajax({
        type: 'GET',
        url: 'http://127.0.0.1:8000/extra/getquickview/' + params,
        data: id,
        success: function (data) {
            ...
            data2 = data.replace('[SCRIPT]', script);
            $('body').append(data2);
        }
    });
}
